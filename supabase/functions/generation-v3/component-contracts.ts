...
export const COMPONENT_REGISTRY: { [K in AllComponentType]: ComponentDefinition<K> } = {
  ...
  Card: {
    ...
    category: 'general',
    requiredProps: [],
    optionalProps: ['title', 'subtitle', 'variant', 'family', 'tone'],
    jsonSchema: {
      type: 'object',
...
/**
 * Validates arbitrary component props fail-closed against the canonical component registry.
 * Rejects unknown properties, missing required fields, and incorrect types.
 */
