import type {
  ...
  LayoutPattern, MotionEasing, NavigationStyle, PillType, PresetChartRules, PresetGeometry,
...
export type ResolvedTypography = { family: string; displayFamily: string; numericFamily?: string; roles: Record<"display" | "title" | "heading" | "body" | "caption" | "label" | "metric" | "metadata", TypeRole> };
...
export type ResolvedNavigationSystem = { modes: readonly NavigationStyle[]; active: NavigationStyle };
export type ResolvedCompositionSystem = { patterns: Record<"dashboard" | "managementList" | "detail" | "form" | "analytics" | "settings", LayoutPattern>; grouping: NonNullable<StyleSystemProfile["groupingStyle"]>; sectionGap: number; contentInset: number };
